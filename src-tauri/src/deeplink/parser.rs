...
//!
//! Parses ccswitchplus:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ccswitchplus:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ccswitchplus://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ccswitchplus" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ccswitchplus', got '{scheme}'"
        )));
    }
