//! Deep link import functionality for CC Switch Plus
//!
//! This module implements the ccswitchplus:// protocol for importing configurations
...
///
/// Represents a parsed ccswitchplus:// URL ready for processing.
